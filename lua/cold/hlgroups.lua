...
function M.get(theme)
	return {
		...
		["Cursor"] = { bg = theme.editor.cursor.bg, fg = theme.editor.cursor.fg },
		...
		["WinSeparator"] = { bg = theme.editor.win.separator.bg, fg = theme.editor.win.separator.fg },
		...
		["LineNr"] = { bg = theme.editor.line_nr.bg, fg = theme.editor.line_nr.fg },
		-- set_hl('LineNrAbove', { bg = '', fg = '' })
		-- set_hl('LineNrBelow', { bg = '', fg = '' })
		["CursorLineNr"] = { bg = theme.editor.cursor.line.nr.bg, fg = theme.editor.cursor.line.nr.fg },
		...
		["FloatBorder"] = { bg = theme.editor.float.border.bg, fg = theme.editor.float.border.fg },
		...
		["PmenuSel"] = { bg = theme.editor.pmenu.sel.bg, fg = theme.editor.pmenu.sel.fg },
		...
		["Search"] = { bg = theme.editor.search.bg, fg = theme.editor.search.fg },
		...
		["StatusLine"] = { bg = theme.editor.status_line.bg, fg = theme.editor.status_line.fg },
		["StatusLineNC"] = { bg = theme.editor.status_line.bg, fg = theme.editor.status_line.fg },
		...
		["Changed"] = { fg = theme.syntax.changed.fg, bg = theme.syntax.changed.bg },
		["Removed"] = { fg = theme.syntax.removed.fg, bg = theme.syntax.removed.bg },
		...
		["LspReferenceWrite"] = { bg = theme.lsp.reference.write.bg, underline = true },
		...
		["DiagnosticUnderlineError"] = { undercurl = true, special = theme.diagnostic.error.fg },
		["DiagnosticUnderlineWarn"] = { undercurl = true, special = theme.diagnostic.warn.fg },
		["DiagnosticUnderlineInfo"] = { undercurl = true, special = theme.diagnostic.info.fg },
		["DiagnosticUnderlineHint"] = { undercurl = true, special = theme.diagnostic.hint.fg },
		["DiagnosticUnderlineOk"] = { undercurl = true, special = theme.diagnostic.ok.fg },
		...
		["NvimTreeNormal"] = { bg = theme.nvim_tree.normal.bg, fg = theme.nvim_tree.normal.fg },
		...
		["StatusLineMode"] = { bg = theme.editor.status_line.mode.bg, fg = theme.editor.status_line.mode.fg },
		["StatusLineMedium"] = { bg = theme.editor.status_line.medium.bg, fg = theme.editor.status_line.medium.fg },

		["StatusLineNeovimLogo"] = { bg = theme.editor.status_line.mode.bg, fg = theme.editor.status_line.mode.fg },

		["StatusLineLspError"] = { bg = theme.editor.status_line.medium.bg, fg = theme.diagnostic.error.fg },
		["StatusLineLspWarn"] = { bg = theme.editor.status_line.medium.bg, fg = theme.diagnostic.warn.fg },
		["StatusLineLspHint"] = { bg = theme.editor.status_line.medium.bg, fg = theme.diagnostic.hint.fg },
		["StatusLineLspInfo"] = { bg = theme.editor.status_line.medium.bg, fg = theme.diagnostic.info.fg },

		["StatusLineLspMessages"] = { bg = theme.editor.status_line.bg, fg = theme.diagnostic.info.fg },
		...
		["StatusLineGitDiffChanged"] = { bg = theme.editor.status_line.medium.bg, fg = theme.editor.diff.change.fg },
		["StatusLineGitDiffRemoved"] = { bg = theme.editor.status_line.medium.bg, fg = theme.editor.diff.delete.fg },
		...
		-- gmr.core.winbar
		["WinBarUnsavedSymbol"] = { bg = theme.bg, fg = theme.editor.status_line.icon.unsaved.fg },

		-- github.com/ibhagwan/fzf-lua
		["FzfLuaNormal"] = { bg = theme.fzf.normal.bg },
		["FzfLuaBorder"] = { bg = theme.fzf.border.bg, fg = theme.fzf.border.fg },
